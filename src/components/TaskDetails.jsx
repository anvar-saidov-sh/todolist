...
const TaskDetails = () => {
  ...
  return (
    <div className=" w-full relative min-h-screen bg-green-600">
      <div className=" max-w-[1300px] px-10 max-md:px-5 m-auto">
        <div>
          <TopNav title={"Task Details"} />

          <div className=" rounded-2xl bg-green-700 max-w-[600px] m-auto mt-16 py-10 px-8 max-sm:p-5 text-white">
