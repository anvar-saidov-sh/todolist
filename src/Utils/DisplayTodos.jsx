...
const DisplayTodos = ({
  ...
  return (
    <>
      {data.length ? (
        <div>
          <div className="max-md:container border text-white max-w-[700px] mt-10 max-sm:mt-2 m-auto rounded-3xl bg-gradient-to-r from-green-500 to-green-700 p-10 max-sm:p-5">
            ...
            <div className="flex flex-col w-[60%] max-sm:w-[100%] mt-7 max-sm:mt-5">
              ...
              <div className="  bg-green-800 w-full h-2 mt-2 rounded-3xl">
                <div
                  className="h-full rounded-3xl transition-all bg-green-100"
          ...
          <div className="max-md:container max-w-[700px] m-auto mt-7 max-sm:mt-5 mb-7 max-sm:mb-5 relative">
            ...
            />
            <IoMdSearch className="absolute top-[50%] left-3 -translate-y-[50%] text-green-600 text-2xl max-sm:text-xl" />
          </div>
