    ...
    <div className=" py-10">
      <form onSubmit={handleSubmit} className="max-w-[600px] m-auto">
        <div>
          <label
            className={`text-sm max-sm:text-xs ${
              nameCountError ? "text-red-500" : "text-green-200"
            } text-green-200`}
            htmlFor="taskName"
          >
            Task Name
        ...
        <div className=" mt-7 max-sm:mt-4">
          <label
            className={`text-sm max-sm:text-xs ${
              descriptionCountError ? "text-red-500" : "text-green-200"
            } text-green-200`}
        ...
        <div ref={catagoryRef} className=" mt-7 max-sm:mt-4">
          <label className="text-sm max-sm:text-xs text-green-200">Category</label>
          ...
          >
            <div className=" flex gap-2 flex-wrap items-center">
              {selectedCatagory.map((val, index) => (
                <div
                  key={index}
                  className=" bg-green-500 text-white text-sm max-sm:text-xs flex items-center gap-1 px-3 py-2 max-sm:py-2 font-medium rounded-lg"
                >
          ...
          {CategoryOpen ? (
            <div className="mt-3">
              <ul className=" p-2 bg-green-400 flex flex-col gap-2 max-sm:gap-1 rounded-xl">
          ...
          <button
            ...
            className={`${
              nameCountError || descriptionCountError
                ? "bg-green-700 cursor-not-allowed text-green-400"
                : "hover:bg-green-800 text-white "
            } transition text-xl font-bold bg-green-400 p-4 max-sm:p-3 max-sm:text-lg rounded-xl w-full`}
          >
            Create Task
          </button>
        </div>
